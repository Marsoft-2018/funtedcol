<?php
    ...
    public function cargar(){
        $this->sql = 'SELECT CONCAT(PrimerNombre," ",SegundoNombre," ",PrimerApellido," ",SegundoApellido) AS nombre,documento,p.`nombre` as programa,DAY(fechaIngreso) AS dia, MONTH(fechaIngreso) AS mes,YEAR(fechaIngreso) AS anho 
